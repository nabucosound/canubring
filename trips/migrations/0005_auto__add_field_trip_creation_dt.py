...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.creation_dt'
        db.add_column(u'trips_trip', 'creation_dt',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 1, 29, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.creation_dt'
        db.delete_column(u'trips_trip', 'creation_dt')
