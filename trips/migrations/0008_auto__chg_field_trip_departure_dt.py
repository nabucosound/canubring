...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trip.departure_dt'
        db.alter_column(u'trips_trip', 'departure_dt', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Trip.departure_dt'
        db.alter_column(u'trips_trip', 'departure_dt', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        u'trips.trip': {
            ...
            'departure_dt': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
