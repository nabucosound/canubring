...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'trips_trip', 'dep_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dep_city_trips', null=True, to=orm['trips.City']),
                      keep_default=False)

        # Adding field 'Trip.dep_country'
        db.add_column(u'trips_trip', 'dep_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dep_country_trips', null=True, to=orm['trips.Country']),
                      keep_default=False)

        # Adding field 'Trip.dest_city'
        db.add_column(u'trips_trip', 'dest_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dest_city_trips', null=True, to=orm['trips.City']),
                      keep_default=False)

        # Adding field 'Trip.dest_country'
        db.add_column(u'trips_trip', 'dest_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dest_country_trips', null=True, to=orm['trips.Country']),
                      keep_default=False)
