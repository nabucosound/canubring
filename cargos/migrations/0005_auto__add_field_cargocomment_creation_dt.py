...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CargoComment.creation_dt'
        db.add_column(u'cargos_cargocomment', 'creation_dt',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 2, 28, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CargoComment.creation_dt'
        db.delete_column(u'cargos_cargocomment', 'creation_dt')
