...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CargoComment.comment_type'
        db.add_column(u'cargos_cargocomment', 'comment_type',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CargoComment.comment_type'
        db.delete_column(u'cargos_cargocomment', 'comment_type')
