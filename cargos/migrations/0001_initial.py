...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cargo'
        db.create_table(u'cargos_cargo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trips.Trip'])),
            ('requesting_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_cargos', to=orm['auth.User'])),
            ('traveller_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requested_cargos', to=orm['auth.User'])),
            ('state', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'cargos', ['Cargo'])
        ...
        db.send_create_signal(u'cargos', ['CargoComment'])


    def backwards(self, orm):
        # Deleting model 'Cargo'
        db.delete_table(u'cargos_cargo')

        # Deleting model 'CargoComment'
        db.delete_table(u'cargos_cargocomment')
