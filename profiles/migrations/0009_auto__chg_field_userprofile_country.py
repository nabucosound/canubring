...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'profiles_userprofile', 'country', 'country_id')
        # Changing field 'UserProfile.country'
        db.alter_column(u'profiles_userprofile', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.ProfileCountry'], null=True))
        # Adding index on 'UserProfile', fields ['country']
        db.create_index(u'profiles_userprofile', ['country_id'])


    def backwards(self, orm):
        # Removing index on 'UserProfile', fields ['country']
        db.delete_index(u'profiles_userprofile', ['country_id'])


        # Renaming column for 'UserProfile.country' to match new field type.
        db.rename_column(u'profiles_userprofile', 'country_id', 'country')
        # Changing field 'UserProfile.country'
        db.alter_column(u'profiles_userprofile', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
