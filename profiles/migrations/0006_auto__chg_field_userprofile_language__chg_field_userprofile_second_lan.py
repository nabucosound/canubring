...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_userprofile', 'language', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'UserProfile.second_language'
        db.alter_column(u'profiles_userprofile', 'second_language', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.language'
        db.alter_column(u'profiles_userprofile', 'language', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'UserProfile.second_language'
        db.alter_column(u'profiles_userprofile', 'second_language', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
