...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.email_verified'
        db.add_column(u'profiles_userprofile', 'email_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.email_verified'
        db.delete_column(u'profiles_userprofile', 'email_verified')
