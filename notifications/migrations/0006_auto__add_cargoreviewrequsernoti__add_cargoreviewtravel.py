...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CargoReviewRequestingUserNotification'
        db.create_table(u'notifications_cargoreviewrequestingusernotification', (
        ...
        db.send_create_signal(u'notifications', ['CargoReviewRequestingUserNotification'])

        # Adding model 'CargoReviewTravellerNotification'
        db.create_table(u'notifications_cargoreviewtravellernotification', (
            (u'notification_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['notifier.Notification'], unique=True, primary_key=True)),
            ('obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cargos.Cargo'])),
        ))
        db.send_create_signal(u'notifications', ['CargoReviewTravellerNotification'])


    def backwards(self, orm):
        # Deleting model 'CargoReviewRequestingUserNotification'
        db.delete_table(u'notifications_cargoreviewrequestingusernotification')

        # Deleting model 'CargoReviewTravellerNotification'
        db.delete_table(u'notifications_cargoreviewtravellernotification')
    ...
    models = {
        ...
        u'notifications.cargoreviewrequestingusernotification': {
            'Meta': {'object_name': 'CargoReviewRequestingUserNotification', '_ormbases': [u'notifier.Notification']},
            u'notification_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['notifier.Notification']", 'unique': 'True', 'primary_key': 'True'}),
            'obj': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cargos.Cargo']"})
        },
