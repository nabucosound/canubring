...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CargoFormNotification'
        db.create_table(u'notifications_cargoformnotification', (
        ...
        db.send_create_signal(u'notifications', ['CargoFormNotification'])


    def backwards(self, orm):
        # Deleting model 'CargoFormNotification'
        db.delete_table(u'notifications_cargoformnotification')
