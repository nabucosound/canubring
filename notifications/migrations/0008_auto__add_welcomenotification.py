...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WelcomeNotification'
        db.create_table(u'notifications_welcomenotification', (
            ...
            ('obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'notifications', ['WelcomeNotification'])


    def backwards(self, orm):
        # Deleting model 'WelcomeNotification'
        db.delete_table(u'notifications_welcomenotification')
    ...
    models = {
        ...
        u'notifications.welcomenotification': {
            'Meta': {'object_name': 'WelcomeNotification', '_ormbases': [u'notifier.Notification']},
            u'notification_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['notifier.Notification']", 'unique': 'True', 'primary_key': 'True'}),
            'obj': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
