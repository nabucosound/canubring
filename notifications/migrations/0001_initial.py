...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CargoCommentNotification'
        db.create_table(u'notifications_cargocommentnotification', (
            ...
            ('obj', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cargos.CargoComment'])),
        ))
        db.send_create_signal(u'notifications', ['CargoCommentNotification'])


    def backwards(self, orm):
        # Deleting model 'CargoCommentNotification'
        db.delete_table(u'notifications_cargocommentnotification')
