...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CargoRejectFormNotification'
        db.create_table(u'notifications_cargorejectformnotification', (
        ...
        db.send_create_signal(u'notifications', ['CargoRejectFormNotification'])


    def backwards(self, orm):
        # Deleting model 'CargoRejectFormNotification'
        db.delete_table(u'notifications_cargorejectformnotification')
