...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CargoConfirmFormNotification'
        db.create_table(u'notifications_cargoconfirmformnotification', (
        ...
        db.send_create_signal(u'notifications', ['CargoConfirmFormNotification'])


    def backwards(self, orm):
        # Deleting model 'CargoConfirmFormNotification'
        db.delete_table(u'notifications_cargoconfirmformnotification')
