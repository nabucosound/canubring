...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CargoDeliveryNotification'
        db.create_table(u'notifications_cargodeliverynotification', (
        ...
        db.send_create_signal(u'notifications', ['CargoDeliveryNotification'])


    def backwards(self, orm):
        # Deleting model 'CargoDeliveryNotification'
        db.delete_table(u'notifications_cargodeliverynotification')
